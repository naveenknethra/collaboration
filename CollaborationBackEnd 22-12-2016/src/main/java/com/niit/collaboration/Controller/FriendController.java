...
public class FriendController {
	...
	@RequestMapping(value="/myaccepetedFriends",method = RequestMethod.GET)
    public ResponseEntity<List<Friends>> getMyAccepetedFriends(HttpSession session) {
	
		Logger.debug("->->->calling method get my friend");
		String loggedInUserID = (String) session.getAttribute("loggedInUserID");
		
		List<Friends> myFriends = friendsDAO.getMyAccepetedFriend(loggedInUserID);
