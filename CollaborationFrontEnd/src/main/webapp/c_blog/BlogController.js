...
app.controller('BlogController',['$scope','BlogService','$location','$rootScope',   
                          	...
                          	self.getSelectedBlog = function getBlog(id){
                          		...
                          		/*self.addrating=function(id,ratingvalue)
                          		{
                          			...
                          			for (var i = 0, length = radios.length; i < length; i++) {
                          			 ...
                          			 self.rating(self.ratingvalue,id); 
                          		}
                          		
                          		self.rating = function(ratingvalue,id)
                          		{
                          		BlogService.addrating(self.ratingvalue,id)
                    			  .then(
                    					function(errResponse){
                    						console.error("Error while creating BlogRating");
                    					}); 
                          		}*/
